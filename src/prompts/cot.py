...
A série temporal tem dados de {num_periods_window} período(s) consecutivos. Cada anotação da série temporal representa a incidência de um evento que ocorre a cada dia.
...
Regras da Saída:
Após analisar os dados fornecidos e compreender os padrões de tráfego, gere uma previsão para os próximos {num_periods_forecast} períodos, com as seguintes regras:
